...
public class PerfilUsuarioActivity extends AppCompatActivity {
        ...
        if (userRef != null) {
            userRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    Toast.makeText(PerfilUsuarioActivity.this, "Error al cargar los datos del usuario", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    private void guardarPerfil() {
        if (userRef != null) {
            ...
            Toast.makeText(PerfilUsuarioActivity.this, "Perfil actualizado exitosamente", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void subirFotoFirebase() {
        if (imageUri != null && userRef != null) {
            StorageReference ref = storageReference.child("fotos_perfil/" + mAuth.getCurrentUser().getUid() + ".jpg");
                ...
                ref.putBytes(data)
                        .addOnSuccessListener(taskSnapshot -> {
                            ...
                            ref.getDownloadUrl().addOnSuccessListener(uri -> {
                                ...
                                Toast.makeText(PerfilUsuarioActivity.this, "Foto de perfil subida con éxito", Toast.LENGTH_SHORT).show();
                            });
                        })
                        .addOnFailureListener(e -> {
                            Toast.makeText(PerfilUsuarioActivity.this, "Error al subir la foto de perfil: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        });
            } catch (IOException e) {
                e.printStackTrace();
                Toast.makeText(PerfilUsuarioActivity.this, "Error al procesar la imagen", Toast.LENGTH_SHORT).show();
            }
        }
    }
